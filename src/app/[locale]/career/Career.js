    ...
    const jobs = [
        {
            ...
            details: {
                job_description:
                    "Phụ trách các chiến dịch truyền thông thương hiệu, quảng bá sản phẩm và tăng tương tác người dùng.",
                job_requirements:
        ...
        },
        {
            ...
            details: {
                job_description:
                    "Chịu trách nhiệm sáng tạo ý tưởng thiết kế cho các chiến dịch truyền thông và nhận diện thương hiệu.",
                job_requirements:
        ...
        },
        {
            ...
            details: {
                job_description:
                    "Lên ý tưởng, sáng tạo nội dung phù hợp cho từng nền tảng mạng xã hội.",
                job_requirements:
                            ...
                            <div key={job.id} className={styles.jobCard} data-aos="fade-right">
                                ...
                                {selectedJob === job.id && (
                                    <div className={styles.jobDetails}>
                                        <p>
                                            <strong>{c.details.desc}:</strong>{" "}
                                            {job.details.job_description}
                                        </p>
                                        <p>
                                            <strong>{c.details.require}:</strong>{" "}
                                            {job.details.job_requirements}
                                        </p>
                                        <p>
                                            <strong>{c.details.deadline}:</strong>{" "}
                                            {job.details.deadline}
                                        </p>
                                        <p>
                                            <strong>{c.details.benefit}:</strong>{" "}
                                            {job.details.benefit}
                                        </p>
